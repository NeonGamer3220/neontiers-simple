...
const DICT = {
  hu: {
    ...
    nav_home: "Főoldal",
    nav_docs_link: "Dokumentumok",
    nav_mod: "Mod",
    nav_legacy: "Legacy",
    col_player: "Játékos",
    col_tiers: "Tierek",
    no_data: "Nincs adat",
    no_saved_tests: "Még nincs mentett teszt eredmény.",
    leaderboard_paused: "Rangsor szünetel",
    no_players: "Nincs játékos",
    col_points: "Pont",
    col_mode: "Mód",
    close: "Bezárás",
    footer_pages: "Oldalak",
    footer_sitemap: "Sitemap",
    footer_last_update: "Eredmények frissítve: legutóbbi teszt futás alapján",
    retired_label: "Visszavonult",
    active_label: "Aktív",
  },
  en: {
    ...
    col_tiers: "Tiers",
    no_data: "No data",
    no_saved_tests: "No test results saved yet.",
    leaderboard_paused: "Leaderboard paused",
    ...
    footer_pages: "Pages",
    footer_sitemap: "Sitemap",
    footer_last_update: "Results updated based on the latest test run",
