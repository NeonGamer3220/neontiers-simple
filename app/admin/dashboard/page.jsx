      ...
      <div className="adminRankPicker">
        ...
        >
          <span className="adminRankButtonText">
            <strong>{value === "" ? "Rangsorolatlan" : value}</strong>
            <span>
              {value === ""
                ? "0 pont"
                : value === "LT5"
          ...
          <div className="adminRankMenu">
            ...
            >
              <span className="adminRankOptionMain">
                <span className="adminRankOptionLabel">Rangsorolatlan</span>
...
.tiersSubtitle {
        ...
        .adminRankOptionMeta {
          ...
          letter-spacing: 0.05em;
          font-weight: 800;
          color: var(--admin-rank-color, rgba(255, 255, 255, 0.55));
        }
