    ...
    <header className="anAdminNav">
      ...
      <style jsx global>{`
        ...
        .anBrandMark {
          ...
          box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.08), 0 6px 18px rgba(143, 124, 255, 0.35);
          font-weight: 900;
          font-size: 14px;
        ...
        .anLink.active {
          color: #fff;
          background: linear-gradient(135deg, rgba(143, 124, 255, 0.3), rgba(214, 71, 71, 0.18));
          box-shadow: inset 0 0 0 1px rgba(143, 124, 255, 0.55), 0 4px 16px rgba(143, 124, 255, 0.25);
        }
        .anLinkGhost {
          margin-left: auto;
        ...
        .anLogoutBtn:hover {
          ...
          box-shadow: 0 4px 16px rgba(214, 71, 71, 0.3);
          transform: translateY(-1px);
        }
        .anMobileFooter {
          display: none;
