...
SET rank = CASE 
    ...
    WHEN rank = 'RHT2' THEN '2500'
    WHEN rank = 'RLT1' THEN '3000'
    WHEN rank = 'RHT1' THEN '4000'
    WHEN rank = 'LT5' THEN '500'
    WHEN rank = 'HT5' THEN '750'
    WHEN rank = 'LT4' THEN '1000'
    WHEN rank = 'HT4' THEN '1250'
    WHEN rank = 'LT3' THEN '1500'
    WHEN rank = 'HT3' THEN '1750'
    WHEN rank = 'LT2' THEN '2000'
    WHEN rank = 'HT2' THEN '2500'
    WHEN rank = 'LT1' THEN '3000'
    WHEN rank = 'HT1' THEN '4000'
    ELSE rank
END;
